...
export declare class DefaultValidationErrorsDirective implements AfterContentInit {
     ...
     */
    errorDirectives: import("@angular/core").Signal<readonly ValidationErrorDirective[]>;
    /**
     * The validation fallback directive (i.e. <ng-template valFallback>) contained inside the directive element.
     */
    fallbackDirective: import("@angular/core").Signal<ValidationFallbackDirective | undefined>;
